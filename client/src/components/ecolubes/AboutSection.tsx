      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            ...
            >
              Ecolube Overseas is a premier exporter based in UAE, specializing in the supply of high-grade Base Oils and Hydrocarbons. Leveraging UAE's strategic position as a global trade hub, we connect quality manufacturers with industries worldwide.
            </motion.p>
