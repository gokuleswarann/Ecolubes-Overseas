    ...
    <section id="products" className="py-20 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-primary">Our Complete Product Catalog</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Premium industrial solvents, petroleum products, and textile chemicals sourced globally.
          </p>
        </div>
        ...
        {categories.map((category) => (
          <div key={category} className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              <h3 className="text-2xl md:text-3xl font-serif font-bold text-primary">{category}</h3>
